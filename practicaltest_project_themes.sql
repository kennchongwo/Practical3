...
CREATE TABLE `project_themes` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK89e6ln224qqwr3a47shq505xn` (`project_id`),
  KEY `FKlk13uuljhgqc2c3elohb3ei8q` (`theme_id`),
  CONSTRAINT `FK89e6ln224qqwr3a47shq505xn` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`),
  CONSTRAINT `FKlk13uuljhgqc2c3elohb3ei8q` FOREIGN KEY (`theme_id`) REFERENCES `theme` (`id`)
