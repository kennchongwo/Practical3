...
CREATE TABLE `project_donors` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK5ry88ymda2mbqsx5vro4a4srf` (`donor_id`),
  KEY `FKgdo0qmlpft0atidsj6kbbfir7` (`project_id`),
  CONSTRAINT `FK5ry88ymda2mbqsx5vro4a4srf` FOREIGN KEY (`donor_id`) REFERENCES `donor` (`id`),
  CONSTRAINT `FKgdo0qmlpft0atidsj6kbbfir7` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`)
